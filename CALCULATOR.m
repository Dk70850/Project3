...
% Last Modified by GUIDE v2.5 02-Feb-2022 15:17:20
...
function INP1_Callback(hObject, eventdata, handles)
% hObject    handle to INP1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of INP1 as text
%        str2double(get(hObject,'String')) returns contents of INP1 as a double


% --- Executes during object creation, after setting all properties.
function INP1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to INP1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
